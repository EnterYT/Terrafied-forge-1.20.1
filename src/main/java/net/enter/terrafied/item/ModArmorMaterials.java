...
public enum ModArmorMaterials implements ArmorMaterial {
    BEDROCK("bedrock_metal", 30, new int[] {6, 8, 7, 4}, 25,
            SoundEvents.ARMOR_EQUIP_GENERIC, 2f, 2f, () -> Ingredient.of(ModItems.BEDROCK_METAL_INGOT.get()));
    ...
    public String getName() {
        return Terrafied.MOD_ID + ":" + this.name;
    }
